...
vmraid.ui.form.on("Bank Statement Import", {
	setup(frm) {
		vmraid.realtime.on("data_import_refresh", ({ data_import }) => {
			frm.import_in_progress = false;
			if (data_import !== frm.doc.name) return;
			vmraid.model.clear_doc("Bank Statement Import", frm.doc.name);
			vmraid.model
	...
	// method: 'vmraid.core.doctype.data_import.data_import.get_preview_from_template',
