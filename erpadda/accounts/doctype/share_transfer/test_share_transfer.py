...
from erpadda.accounts.doctype.share_transfer.share_transfer import ShareDontExists
...
class TestShareTransfer(unittest.TestCase):
	def setUp(self):
		vmraid.db.sql("delete from `tabShare Transfer`")
		vmraid.db.sql("delete from `tabShare Balance`")
		share_transfers = [
			{
