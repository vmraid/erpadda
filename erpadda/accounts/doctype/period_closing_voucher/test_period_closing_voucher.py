...
from erpadda.accounts.doctype.finance_book.test_finance_book import create_finance_book
...
from erpadda.accounts.utils import get_fiscal_year, now


class TestPeriodClosingVoucher(unittest.TestCase):
	def test_closing_entry(self):
		vmraid.db.sql("delete from `tabGL Entry` where company='Test PCV Company'")
...
test_records = vmraid.get_test_records("Period Closing Voucher")
