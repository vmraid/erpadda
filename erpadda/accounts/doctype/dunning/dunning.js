...
vmraid.ui.form.on("Dunning", {
	...
	get_dunning_letter_text: function (frm) {
		if (frm.doc.dunning_type) {
			vmraid.call({
				method:
				"erpadda.accounts.doctype.dunning.dunning.get_dunning_letter_text",
				args: {
	...
	make_payment_entry: function (frm) {
		return vmraid.call({
			method:
			"erpadda.accounts.doctype.payment_entry.payment_entry.get_payment_entry",
			args: {
				dt: frm.doc.doctype,
				dn: frm.doc.name,
			},
