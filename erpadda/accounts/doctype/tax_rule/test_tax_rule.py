...
from erpadda.accounts.doctype.tax_rule.tax_rule import ConflictingTaxRule, get_tax_template
...
test_records = vmraid.get_test_records("Tax Rule")


class TestTaxRule(unittest.TestCase):
	@classmethod
	def setUpClass(cls):
		vmraid.db.set_value("Shopping Cart Settings", None, "enabled", 0)
...
def make_tax_rule(**args):
	...
	tax_rule = vmraid.new_doc("Tax Rule")
