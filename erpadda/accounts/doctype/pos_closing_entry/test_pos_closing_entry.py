...
from erpadda.accounts.doctype.pos_closing_entry.pos_closing_entry import (
...
class TestPOSClosingEntry(unittest.TestCase):
	...
	def test_cancelling_of_pos_closing_entry(self):
		...
		cancelled_invoice = vmraid.db.get_value(
			"POS Invoice Merge Log", {"pos_closing_entry": pcv_doc.name}, "consolidated_invoice"
		)
		docstatus = vmraid.db.get_value("Sales Invoice", cancelled_invoice, "docstatus")
