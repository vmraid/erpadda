...
def execute(filters=None):
	...
	account_currency = vmraid.db.get_value("Account", filters.account, "account_currency")
...
def get_loan_entries(filters):
	...
	for doctype in ["Loan Disbursement", "Loan Repayment"]:
		loan_doc = vmraid.qb.DocType(doctype)
