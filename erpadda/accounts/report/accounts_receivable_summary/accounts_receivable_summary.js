...
vmraid.query_reports["Accounts Receivable Summary"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
	...
	onload: function(report) {
		report.page.add_inner_button(__("Accounts Receivable"), function() {
			...
			vmraid.set_route('query-report', 'Accounts Receivable', { company: filters.company });
		});
	}
}

erpadda.utils.add_dimensions('Accounts Receivable Summary', 9);
