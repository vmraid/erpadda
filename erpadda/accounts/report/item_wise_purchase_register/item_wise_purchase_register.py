...
import erpadda
from erpadda.accounts.report.item_wise_sales_register.item_wise_sales_register import (
	add_sub_total_row,
	add_total_row,
	get_grand_total,
...
from erpadda.selling.report.item_wise_sales_history.item_wise_sales_history import get_item_details
...
def get_aii_accounts():
	return dict(vmraid.db.sql("select name, stock_received_but_not_billed from tabCompany"))


def get_purchase_receipts_against_purchase_order(item_list):
	po_pr_map = vmraid._dict()
	po_item_rows = list(set(d.po_detail for d in item_list))

	if po_item_rows:
		purchase_receipts = vmraid.db.sql(
			"""
