import vmraid
from vmraid.utils import flt, formatdate, get_datetime_str

from erpadda import get_company_currency, get_default_company
from erpadda.accounts.doctype.fiscal_year.fiscal_year import get_from_and_to_date
...
def get_invoiced_item_gross_margin(
	...
	from erpadda.accounts.report.gross_profit.gross_profit import GrossProfitGenerator

	sales_invoice = sales_invoice or vmraid.form_dict.get("sales_invoice")
	item_code = item_code or vmraid.form_dict.get("item_code")
	company = company or vmraid.get_cached_value("Sales Invoice", sales_invoice, "company")
