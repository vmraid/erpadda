...
from erpadda.accounts.report.tds_payable_monthly.tds_payable_monthly import (
	get_result,
	get_tds_docs,
)
...
def execute(filters=None):
	...
	filters.naming_series = vmraid.db.get_single_value("Buying Settings", "supp_master_name")
...
def validate_filters(filters):
	...
	if from_year != to_year:
		vmraid.throw(_("From Date and To Date lie in different Fiscal Year"))
