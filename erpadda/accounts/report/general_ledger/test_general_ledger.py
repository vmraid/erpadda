...
from erpadda.accounts.report.general_ledger.general_ledger import execute


class TestGeneralLedger(VMRaidTestCase):
	def test_foreign_account_balance_after_exchange_rate_revaluation(self):
		...
		revaluation = vmraid.new_doc("Exchange Rate Revaluation")
		...
		revaluation_jv = vmraid.get_doc(revaluation_jv)
