...
class TestTaxDetail(unittest.TestCase):
	def load_testdocs(self):
		from erpadda.accounts.utils import FiscalYearError, get_fiscal_year
	...
	def load_defcols(self):
		self.company = vmraid.get_doc("Company", "_T")
		custom_report = vmraid.get_doc("Report", "Tax Detail")
	...
	def rm_testdocs(self):
		...
		from erpadda.setup.doctype.company.company import create_transaction_deletion_request
