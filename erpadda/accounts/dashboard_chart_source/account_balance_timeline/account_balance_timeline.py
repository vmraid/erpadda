...
from vmraid.utils import add_to_date, formatdate, get_link_to_form, getdate, nowdate
from vmraid.utils.dashboard import cache_source
from vmraid.utils.dateutils import get_from_date_from_timespan, get_period_ending
...
def get(
	...
	if not vmraid.db.exists("Account", account) and chart_name:
		vmraid.throw(
...
def build_result(account, dates, gl_entries):
	...
	root_type = vmraid.db.get_value("Account", account, "root_type")
