...
class ERPAddaAddress(Address):
	...
	def on_update(self):
		...
		customers = vmraid.db.get_all("Customer", filters=filters, as_list=True)
		for customer_name in customers:
			vmraid.db.set_value("Customer", customer_name[0], "primary_address", address_display)
...
def get_shipping_address(company, address=None):
	...
	fields = ["*"]
	if address and vmraid.db.get_value("Dynamic Link", {"parent": address, "link_name": company}):
