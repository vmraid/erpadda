...
def execute(filters=None):
	...
	program_enrollments = vmraid.get_list(
		"Program Enrollment",
...
def get_student_details(student_list):
	student_map = vmraid._dict()
	student_details = vmraid.db.sql(
		"""
...
def get_guardian_map(student_list):
	guardian_map = vmraid._dict()
	guardian_details = vmraid.db.sql(
		"""
