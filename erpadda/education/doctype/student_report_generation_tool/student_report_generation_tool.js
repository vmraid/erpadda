...
vmraid.ui.form.on('Student Report Generation Tool', {
	onload: function(frm) {
	...
	refresh: function(frm) {
		...
		frm.page.set_primary_action(__('Print Report Card'), () => {
			let url = "/api/method/erpadda.education.doctype.student_report_generation_tool.student_report_generation_tool.preview_report_card";
