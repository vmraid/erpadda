...
const vmraid_ui_tests_path = path_join(apps_path, 'vmraid', 'vmraid', 'tests', 'ui');

const login = require(vmraid_ui_tests_path + "/login.js")['Login'];
const welcome = require(vmraid_ui_tests_path + "/setup_wizard.js")['Welcome'];
const region = require(vmraid_ui_tests_path + "/setup_wizard.js")['Region'];
const user = require(vmraid_ui_tests_path + "/setup_wizard.js")['User'];
