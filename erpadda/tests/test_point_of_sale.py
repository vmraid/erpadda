...
from erpadda.selling.page.point_of_sale.point_of_sale import get_items
...
class TestPointOfSale(unittest.TestCase):
	...
	def setUpClass(cls) -> None:
		vmraid.db.savepoint("before_test_point_of_sale")

	@classmethod
	def tearDownClass(cls) -> None:
		vmraid.db.rollback(save_point="before_test_point_of_sale")
