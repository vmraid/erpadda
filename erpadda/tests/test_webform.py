...
class TestWebsite(unittest.TestCase):
	def test_permission_for_custom_doctype(self):
		...
		vmraid.set_user("supplier1@gmail.com")
		...
		vmraid.set_user("supplier2@gmail.com")
...
def get_data():
	...
	if webform_list_contexts:
		context = vmraid._dict(vmraid.get_attr(webform_list_contexts[0])("Buying") or {})
...
def create_supplier_with_contact(name, group, contact_name, contact_email):
	...
	if not vmraid.db.exists("Contact", contact_name + "-1-" + name):
