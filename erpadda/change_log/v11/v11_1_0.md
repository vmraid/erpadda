- Enhancements
	...
	- Other Features
		...
		- A free marketplace where any ERPAdda user can list their products and be discovered by thousands of other companies using ERPAdda
...
- Changes have been made to ensure ERPAdda is compatible with Python 3
