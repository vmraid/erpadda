...
erpadda.StockGridReport = class StockGridReport extends vmraid.views.TreeGridReport {
	...
	get_serialized_buying_rates() {
		...
		if (vmraid.report_dump.data["Serial No"]) {
			$.each(vmraid.report_dump.data["Serial No"], function(i, sn) {
