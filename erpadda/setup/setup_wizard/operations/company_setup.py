...
def create_email_digest():
	...
	companies = vmraid.db.sql_list("select name FROM `tabCompany`")
	for company in companies:
		if not vmraid.db.exists("Email Digest", "Default Weekly Digest - " + company):
			edigest = vmraid.get_doc(
				{
	...
	if companies:
		edigest = vmraid.new_doc("Email Digest")
		edigest.update(
			{
