...
import vmraid
from vmraid.utils.data import today

# test_records = vmraid.get_test_records('Maintenance Visit')
...
def make_maintenance_visit():
	mv = vmraid.new_doc("Maintenance Visit")
...
def make_sales_person(name):
	sales_person = vmraid.get_doc({"doctype": "Sales Person", "sales_person_name": name})
