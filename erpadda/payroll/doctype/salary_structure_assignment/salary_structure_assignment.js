...
vmraid.ui.form.on('Salary Structure Assignment', {
	setup: function(frm) {
		...
		frm.set_query("payroll_payable_account", function() {
			var company_currency = erpadda.get_currency(frm.doc.company);
			return {
				filters: {
					"company": frm.doc.company,
					"root_type": "Liability",
	...
	company: function(frm) {
		if (frm.doc.company) {
			vmraid.db.get_value("Company", frm.doc.company, "default_payroll_payable_account", (r) => {
