...
vmraid.ui.form.on('Payroll Settings', {
	...
	validate: function(frm) {
		...
		if (policy) {
			if (policy.includes(' ') || policy.includes('--')) {
				vmraid.msgprint(__("Password policy cannot contain spaces or simultaneous hyphens. The format will be restructured automatically"));
			}
