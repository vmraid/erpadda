...
import erpadda
from erpadda.regional.report.provident_fund_deductions.provident_fund_deductions import (
	get_conditions,
)
...
def get_payment_modes():
	mode_of_payments = vmraid.db.sql_list(
		"""
...
def get_data(filters, mode_of_payments):
	...
	if data:
		...
		currency = erpadda.get_company_currency(filters.company)
