...
def execute(filters=None):
	...
	if vmraid.db.has_column("Employee", "ifsc_code"):
		columns.append(
	...
	for salary in salary_slips:
		if (
			...
			row = {
				...
				"payment_date": vmraid.utils.formatdate(salary.modified.strftime("%Y-%m-%d")),
				...
				"currency": vmraid.get_cached_value("Company", filters.company, "default_currency"),
