...
from erpadda.payroll.report.income_tax_computation.income_tax_computation import execute
...
class TestIncomeTaxComputation(unittest.TestCase):
	...
	def cleanup_records(self):
		...
		vmraid.db.sql("delete from `tabIncome Tax Slab`")
		vmraid.db.sql("delete from `tabSalary Component`")
		vmraid.db.sql("delete from `tabEmployee Benefit Application`")
		vmraid.db.sql("delete from `tabEmployee Benefit Claim`")
		vmraid.db.sql("delete from `tabEmployee` where company='_Test Company'")
