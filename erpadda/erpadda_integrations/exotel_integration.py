...
# api/method/erpadda.erpadda_integrations.exotel_integration.handle_incoming_call
# api/method/erpadda.erpadda_integrations.exotel_integration.handle_end_call
# api/method/erpadda.erpadda_integrations.exotel_integration.handle_missed_call
...
def handle_incoming_call(**kwargs):
	try:
		...
		vmraid.db.rollback()
		vmraid.log_error(title=_("Error in Exotel incoming call"))
		vmraid.db.commit()
...
def get_call_log(call_payload):
	...
	if vmraid.db.exists("Call Log", call_log_id):
		return vmraid.get_doc("Call Log", call_log_id)


def create_call_log(call_payload):
	call_log = vmraid.new_doc("Call Log")
...
def get_exotel_settings():
	return vmraid.get_single("Exotel Settings")
