...
vmraid.provide("erpadda.support");

vmraid.ui.form.on("Warranty Claim", {
	setup: function(frm) {
...
erpadda.support.WarrantyClaim = class WarrantyClaim extends vmraid.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new erpadda.support.WarrantyClaim({frm: cur_frm}));
