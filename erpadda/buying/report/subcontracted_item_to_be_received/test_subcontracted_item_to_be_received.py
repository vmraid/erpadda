...
# Embedded file name: /Users/anuragmishra/vmraid-develop/apps/erpadda/erpadda/buying/report/subcontracted_item_to_be_received/test_subcontracted_item_to_be_received.py
...
from erpadda.buying.report.subcontracted_item_to_be_received.subcontracted_item_to_be_received import (
	execute,
)
from erpadda.stock.doctype.stock_entry.test_stock_entry import make_stock_entry


class TestSubcontractedItemToBeReceived(VMRaidTestCase):
