...
from vmraid.utils import date_diff, flt, getdate
...
def validate_filters(filters):
	...
	if not from_date and to_date:
		vmraid.throw(_("From and To Dates are required."))
	elif date_diff(to_date, from_date) < 0:
		vmraid.throw(_("To Date cannot be before From Date."))


def get_data(filters):
	mr = vmraid.qb.DocType("Material Request")
	mr_item = vmraid.qb.DocType("Material Request Item")
