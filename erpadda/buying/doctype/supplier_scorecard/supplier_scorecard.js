...
/* global vmraid, refresh_field */

vmraid.ui.form.on("Supplier Scorecard", {
	setup: function(frm) {
	...
	load_criteria: function(frm) {
		vmraid.call({
			method: "erpadda.buying.doctype.supplier_scorecard_criteria.supplier_scorecard_criteria.get_criteria_list",
			callback: function(r) {
...
vmraid.ui.form.on("Supplier Scorecard Scoring Standing", {

	standing_name: function(frm, cdt, cdn) {
		var d = vmraid.get_doc(cdt, cdn);
		if (d.standing_name) {
			return frm.call({
				method: "erpadda.buying.doctype.supplier_scorecard_standing.supplier_scorecard_standing.get_scoring_standing",
				child: d,
				args: {
...
vmraid.ui.form.on("Supplier Scorecard Scoring Criteria", {
...
var loadAllStandings = function(frm) {
	vmraid.call({
		method: "erpadda.buying.doctype.supplier_scorecard_standing.supplier_scorecard_standing.get_standings_list",
		callback: function(r) {
