...
from erpadda.buying.doctype.request_for_quotation.request_for_quotation import (
	create_supplier_quotation,
	make_supplier_quotation_from_rfq,
)
from erpadda.crm.doctype.opportunity.opportunity import make_request_for_quotation as make_rfq
from erpadda.crm.doctype.opportunity.test_opportunity import make_opportunity
from erpadda.stock.doctype.item.test_item import make_item
from erpadda.templates.pages.rfq import check_supplier_has_docname_access


class TestRequestforQuotation(VMRaidTestCase):
	...
	def test_make_supplier_quotation_with_special_characters(self):
		vmraid.delete_doc_if_exists("Supplier", "_Test Supplier '1", force=1)
	...
	def test_make_supplier_quotation_from_portal(self):
		...
		supplier_quotation_doc = vmraid.get_doc("Supplier Quotation", supplier_quotation_name)
	...
	def test_make_multi_uom_supplier_quotation(self):
		...
		supplier_quotation_name = create_supplier_quotation(rfq)
		supplier_quotation = vmraid.get_doc("Supplier Quotation", supplier_quotation_name)
...
def make_request_for_quotation(**args):
	...
	rfq = vmraid.new_doc("Request for Quotation")
