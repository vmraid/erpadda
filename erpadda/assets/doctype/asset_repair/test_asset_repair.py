...
from erpadda.assets.doctype.asset.test_asset import (
	create_asset,
	create_asset_data,
...
class TestAssetRepair(unittest.TestCase):
	...
	def test_update_status(self):
		...
		asset_repair.save()
		asset_status = vmraid.db.get_value("Asset", asset_repair.asset, "status")
	...
	def test_decrease_stock_quantity(self):
		...
		stock_entry = vmraid.get_last_doc("Stock Entry")
	...
	def test_serialized_item_consumption(self):
		from erpadda.stock.doctype.serial_no.serial_no import SerialNoRequiredError
	...
	def test_gl_entries(self):
		asset_repair = create_asset_repair(capitalize_repair_cost=1, submit=1)
		gl_entry = vmraid.get_last_doc("GL Entry")
