...
from vmraid.utils import cint, date_diff, flt, formatdate, getdate
...
from erpadda.assets.doctype.asset.depreciation import get_depreciation_accounts
from erpadda.regional.india.utils import (
...
class AssetValueAdjustment(Document):
	...
	def validate_date(self):
		asset_purchase_date = vmraid.db.get_value("Asset", self.asset, "purchase_date")
	...
	def make_depreciation_entry(self):
		asset = vmraid.get_doc("Asset", self.asset)
		(
			fixed_asset_account,
	...
	def reschedule_depreciations(self, asset_value):
		asset = vmraid.get_doc("Asset", self.asset)
		country = vmraid.get_value("Company", self.company, "country")
...
def get_current_asset_value(asset, finance_book=None):
	...
	return vmraid.db.get_value("Asset Finance Book", cond, "value_after_depreciation")
