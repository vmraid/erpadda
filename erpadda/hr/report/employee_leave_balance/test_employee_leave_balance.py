...
import vmraid
from vmraid.utils import add_days, add_months, flt, get_year_ending, get_year_start, getdate
...
from erpadda.hr.report.employee_leave_balance.employee_leave_balance import execute
from erpadda.payroll.doctype.salary_slip.test_salary_slip import (
	make_holiday_list,
	make_leave_application,
)

test_records = vmraid.get_test_records("Leave Type")
