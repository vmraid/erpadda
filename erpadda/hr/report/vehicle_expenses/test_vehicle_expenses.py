...
from erpadda.hr.doctype.vehicle_log.test_vehicle_log import get_vehicle, make_vehicle_log
from erpadda.hr.doctype.vehicle_log.vehicle_log import make_expense_claim
from erpadda.hr.report.vehicle_expenses.vehicle_expenses import execute


class TestVehicleExpenses(unittest.TestCase):
	@classmethod
	def setUpClass(self):
		vmraid.db.sql("delete from `tabVehicle Log`")

		employee_id = vmraid.db.sql(
