...
import vmraid
from vmraid.utils import add_days, flt, get_year_ending, get_year_start, getdate
...
from erpadda.hr.report.employee_leave_balance_summary.employee_leave_balance_summary import execute
	...
	def test_employee_leave_balance_summary(self):
		...
		expected_data = [
			[
				...
				vmraid.db.get_value("Employee", self.employee_id, "department"),
				flt(
