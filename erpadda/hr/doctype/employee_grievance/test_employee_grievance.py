...
def create_employee_grievance():
	...
	grievance = vmraid.new_doc("Employee Grievance")
...
def create_grievance_type():
	if vmraid.db.exists("Grievance Type", "Employee Abuse"):
		return vmraid.get_doc("Grievance Type", "Employee Abuse")
	grievance_type = vmraid.new_doc("Grievance Type")
