...
from erpadda.hr.doctype.shift_assignment.shift_assignment import OverlappingShiftError
from erpadda.hr.doctype.shift_type.test_shift_type import make_shift_assignment, setup_shift_type

test_dependencies = ["Shift Type"]


class TestShiftAssignment(VMRaidTestCase):
	def setUp(self):
	...
	def test_overlapping_for_ongoing_shift(self):
		...
		setup_shift_type(shift_type="Day Shift")
		shift_assignment_1 = vmraid.get_doc(
			{
				"doctype": "Shift Assignment",
				"shift_type": "Day Shift",
				"company": "_Test Company",
	...
	def test_overlapping_for_fixed_period_shift(self):
		...
		shift_assignment_3 = vmraid.get_doc(
			{
				"doctype": "Shift Assignment",
				"shift_type": "Day Shift",
				"company": "_Test Company",
