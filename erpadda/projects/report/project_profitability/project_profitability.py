...
def get_rows(filters):
	...
	return vmraid.db.sql(sql, filters, as_dict=True)
...
def get_conditions(filters):
	...
	if filters.get("company"):
		conditions.append("tabTimesheet.company={0}".format(vmraid.db.escape(filters.get("company"))))
	...
	if filters.get("customer_name"):
		conditions.append("si.customer_name={0}".format(vmraid.db.escape(filters.get("customer_name"))))

	if filters.get("employee"):
		conditions.append("tabTimesheet.employee={0}".format(vmraid.db.escape(filters.get("employee"))))

	if filters.get("project"):
		conditions.append(
			"tabTimesheet.parent_project={0}".format(vmraid.db.escape(filters.get("project")))
		)
