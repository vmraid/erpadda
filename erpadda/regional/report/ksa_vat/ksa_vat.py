...
from vmraid.utils import get_url_to_list
...
def get_data(filters):
	...
	if vmraid.db.exists("KSA VAT Setting", company) is None:
		url = get_url_to_list("KSA VAT Setting")
		vmraid.msgprint(_('Create <a href="{}">KSA VAT Setting</a> for this company').format(url))
		return data

	ksa_vat_setting = vmraid.get_doc("KSA VAT Setting", company)
...
def get_tax_amount(item_code, account_head, doctype, parent):
	...
	item_wise_tax_detail = vmraid.get_value(
		tax_doctype,
