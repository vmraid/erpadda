...
def setup(company=None, patch=True):
	...
	if vmraid.db.count("Company", {"country": "United States"}) <= 1:
...
def add_print_formats():
	vmraid.reload_doc("regional", "print_format", "irs_1099_form")
	vmraid.db.set_value("Print Format", "IRS 1099 Form", "disabled", 0)
