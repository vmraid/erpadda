...
from erpadda.regional.address_template.setup import get_address_templates, update_address_template
...
def ensure_country(country):
	if vmraid.db.exists("Country", country):
		...
		c = vmraid.get_doc({"doctype": "Country", "country_name": country})
		c.insert()
		return c
