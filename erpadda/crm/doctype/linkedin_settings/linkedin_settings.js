...
vmraid.ui.form.on('LinkedIn Settings', {
	onload: function(frm) {
		...
		frm.dashboard.set_headline(__("For more information, {0}.", [`<a target='_blank' href='https://docs.erpadda.com/docs/user/manual/en/CRM/linkedin-settings'>${__('Click here')}</a>`]));
	},
