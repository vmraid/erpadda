vmraid.listview_settings['Lead'] = {
	onload: function(listview) {
		if (vmraid.boot.user.can_create.includes("Prospect")) {
			listview.page.add_action_item(__("Create Prospect"), function() {
				vmraid.model.with_doctype("Prospect", function() {
					...
					vmraid.db.get_value("Lead", leads[0].name, ["company_name", "no_of_employees", "industry", "market_segment", "territory", "fax", "website", "lead_owner"], (r) => {
