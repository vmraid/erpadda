...
from vmraid.utils import date_diff, flt
...
def get_communication_details(filters):
	...
	communication_list = []
	opportunities = vmraid.db.get_values(
		"Opportunity",
	...
	for d in opportunities:
		...
		communication_count = vmraid.db.sql(
			"""
				SELECT
					count(*)
				FROM
		...
		support_tickets = len(vmraid.db.get_all("Issue", {"raised_by": d.contact_email}))
