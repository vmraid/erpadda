...
def get_leaderboards():
	leaderboards = {
		"Customer": {
			...
			"method": "erpadda.startup.leaderboard.get_all_customers",
			"icon": "customer",
		},
		"Item": {
			"fields": [
			...
			"method": "erpadda.startup.leaderboard.get_all_items",
			"icon": "stock",
		},
		"Supplier": {
			"fields": [
			...
			"method": "erpadda.startup.leaderboard.get_all_suppliers",
			"icon": "buying",
		},
		"Sales Partner": {
			"fields": [
			...
			"method": "erpadda.startup.leaderboard.get_all_sales_partner",
			"icon": "hr",
		},
		"Sales Person": {
			"fields": [{"fieldname": "total_sales_amount", "fieldtype": "Currency"}],
			"method": "erpadda.startup.leaderboard.get_all_sales_person",
			"icon": "customer",
		},
	}
...
def get_date_condition(date_range, field):
	...
	if date_range:
		...
		date_condition = "and {0} between {1} and {2}".format(
			field, vmraid.db.escape(from_date), vmraid.db.escape(to_date)
		)
