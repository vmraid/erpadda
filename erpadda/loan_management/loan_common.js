...
vmraid.ui.form.on(cur_frm.doctype, {
	refresh: function(frm) {
		if (!vmraid.boot.active_domains.includes("Non Profit")) {
	...
	applicant: function(frm) {
		...
		if (frm.doc.applicant) {
			vmraid.model.with_doc(frm.doc.applicant_type, frm.doc.applicant, function() {
				var applicant = vmraid.model.get_doc(frm.doc.applicant_type, frm.doc.applicant);
