...
def get_active_loan_details(filters):
	...
	currency = erpadda.get_company_currency(filters.get("company"))
...
def get_interest_accruals(loans):
	...
	interest_accruals = vmraid.get_all(
...
def get_penal_interest_rate_map():
	return vmraid._dict(
		vmraid.get_all("Loan Type", fields=["name", "penalty_interest_rate"], as_list=1)
	)
