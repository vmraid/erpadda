...
def execute(filters=None):
	if not filters:
		filters = {}
	float_precision = vmraid.db.get_default("float_precision")
	...
	if diff <= 0:
		vmraid.throw(_("'From Date' must be after 'To Date'"))
...
def get_condition(filters):
	...
	if filters.get("from_date") and filters.get("to_date"):
		...
		vmraid.throw(_("From and To dates required"))
	return conditions
