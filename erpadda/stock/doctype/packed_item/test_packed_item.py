...
from vmraid.utils import add_to_date, nowdate
...
class TestPackedItem(VMRaidTestCase):
	...
	def test_returning_full_bundles(self):
		from erpadda.stock.doctype.delivery_note.delivery_note import make_sales_return
