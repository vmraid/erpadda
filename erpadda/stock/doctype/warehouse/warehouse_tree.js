vmraid.treeview_settings['Warehouse'] = {
	get_tree_nodes: "erpadda.stock.doctype.warehouse.warehouse.get_children",
	add_tree_node: "erpadda.stock.doctype.warehouse.warehouse.add_node",
	get_tree_root: false,
