...
from erpadda.accounts.report.utils import convert


def validate_filters(from_date, to_date, company):
	if from_date and to_date and (from_date >= to_date):
		vmraid.throw(_("To Date must be greater than From Date"))
...
def get_opp_by_lead_source(from_date, to_date, company):
	...
	if opportunities:
		default_currency = vmraid.get_cached_value("Global Defaults", "None", "default_currency")
