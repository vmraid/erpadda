erpadda.PointOfSale.PastOrderList = class {
	...
	make_filter_section() {
		...
		this.status_field = vmraid.ui.form.make_control({
			df: {
	...
	refresh_list() {
		...
		return vmraid.call({
			method: "erpadda.selling.page.point_of_sale.point_of_sale.get_past_order_list",
			freeze: true,
			...
			`<div class="invoice-wrapper" data-invoice-name="${escape(invoice.name)}">
				<div class="invoice-name-date">
					...
					<div class="invoice-date">
						...
						${vmraid.ellipsis(invoice.customer, 20)}
					</div>
				</div>
