...
from erpadda.selling.report.sales_analytics.sales_analytics import execute


class TestAnalytics(VMRaidTestCase):
	def test_sales_analytics(self):
		vmraid.db.sql("delete from `tabSales Order` where company='_Test Company 2'")
