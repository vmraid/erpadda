vmraid.listview_settings['Quotation'] = {
	...
	onload: function(listview) {
		...
		listview.page.add_action_item(__("Sales Order"), ()=>{
			erpadda.bulk_transaction_processing.create(listview, "Quotation", "Sales Order");
		});

		listview.page.add_action_item(__("Sales Invoice"), ()=>{
			erpadda.bulk_transaction_processing.create(listview, "Quotation", "Sales Invoice");
		});
	},
