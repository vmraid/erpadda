...
from erpadda.controllers.queries import item_query
...
class TestPartySpecificItem(VMRaidTestCase):
	def setUp(self):
		self.customer = vmraid.get_last_doc("Customer")
		self.supplier = vmraid.get_last_doc("Supplier")
		self.item = vmraid.get_last_doc("Item")
