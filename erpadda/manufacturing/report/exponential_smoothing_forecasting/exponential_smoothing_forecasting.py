...
from vmraid.utils import add_years, cint, flt, getdate
...
class ForecastingReport(ExponentialSmoothingForecast):
	def __init__(self, filters=None):
		...
		self.company_currency = erpadda.get_company_currency(self.filters.company)
	...
	def get_data_for_forecast(self):
		...
		if self.filters.item_code:
			cond = " AND soi.item_code = %s" % (vmraid.db.escape(self.filters.item_code))
	...
	def add_total(self):
		...
		total_row = {"item_code": _(vmraid.bold("Total Quantity"))}
