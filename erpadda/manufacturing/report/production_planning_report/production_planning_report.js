...
vmraid.query_reports["Production Planning Report"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
		...
		},
		{
			...
			"reqd": 1,
			on_change: function() {
				let filters = vmraid.query_report.filters;
				let based_on = vmraid.query_report.get_filter_value('based_on');
				let options = {
		...
		},
		{
			...
			"get_data": function(txt) {
				...
				return vmraid.db.get_link_options(based_on, txt);
			},
			"get_query": function() {
