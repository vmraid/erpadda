...
from vmraid.utils.data import comma_and
...
def execute(filters=None):
	...
	for row in data:
		...
		last_pur_price = vmraid.db.get_value("Item", row.item_code, "last_purchase_rate")
...
def get_bom_stock(filters):
	...
	if filters.get("warehouse"):
		...
		if warehouse_details:
			...
			conditions += " and ledger.warehouse = %s" % vmraid.db.escape(filters.get("warehouse"))
