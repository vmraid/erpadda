...
from erpadda.manufacturing.doctype.routing.test_routing import create_routing, setup_bom
from erpadda.manufacturing.doctype.workstation.workstation import (
...
class TestWorkstation(VMRaidTestCase):
	...
	def test_update_bom_operation_rate(self):
		...
		w1 = vmraid.get_doc("Workstation", "_Test Workstation A")
		# resets values
...
def make_workstation(*args, **kwargs):
	...
	if not vmraid.db.exists("Workstation", workstation_name):
		doc = vmraid.get_doc({"doctype": "Workstation", "workstation_name": workstation_name})
