...
class TestECommerceSettings(unittest.TestCase):
	...
	def get_cart_settings(self):
		return vmraid.get_doc({"doctype": "E Commerce Settings", "company": "_Test Company"})

	# NOTE: Exchangrate API has all enabled currencies that ERPAdda supports.
...
def setup_e_commerce_settings(values_dict):
	...
	doc = vmraid.get_doc("E Commerce Settings", "E Commerce Settings")
