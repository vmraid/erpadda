import vmraid
from vmraid.utils import get_time, getdate, today

from erpadda.accounts.utils import update_gl_entries_after
from erpadda.stock.stock_ledger import update_entries_after
...
def execute():
	...
	vmraid.clear_cache()
	vmraid.flags.warehouse_account_map = {}
	...
	if data:
		for row in vmraid.get_all("Company", filters={"enable_perpetual_inventory": 1}):
