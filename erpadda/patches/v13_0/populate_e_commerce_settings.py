...
def execute():
	...
	vmraid.reload_doc("portal", "doctype", "website_filter_field")
	vmraid.reload_doc("portal", "doctype", "website_attribute")
	...
	settings = vmraid.get_doc("E Commerce Settings")

	def map_into_e_commerce_settings(doctype, fields):
		singles = vmraid.qb.DocType("Singles")
		query = (
			vmraid.qb.from_(singles)
