...
def execute():
	if vmraid.db.table_exists("Membership Settings"):
		vmraid.rename_doc("DocType", "Membership Settings", "Non Profit Settings")
		vmraid.reload_doctype("Non Profit Settings", force=True)

	if vmraid.db.table_exists("Non Profit Settings"):
		rename_fields_map = {
