...
def execute():
	if vmraid.db.exists("DocType", "Lost Reason Detail"):
		vmraid.reload_doc("crm", "doctype", "opportunity_lost_reason")
		vmraid.reload_doc("crm", "doctype", "opportunity_lost_reason_detail")
		vmraid.reload_doc("setup", "doctype", "quotation_lost_reason_detail")
		...
		vmraid.delete_doc("DocType", "Lost Reason Detail")
