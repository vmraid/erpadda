...
from erpadda.regional.india.setup import add_permissions, add_print_formats
...
def execute():
	...
	vmraid.reload_doc("regional", "doctype", "e_invoice_settings")
	custom_fields = {
		"Sales Invoice": [
			dict(
				fieldname="irn",
	...
	for field, conditions in t.items():
		for c in conditions:
			[(prop, value)] = c.items()
			vmraid.db.set_value("Custom Field", {"fieldname": field}, prop, value)
