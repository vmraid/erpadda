...
class TestTaxes(unittest.TestCase):
	def setUp(self):
		...
		self.item_group = vmraid.get_doc(
			{
				"doctype": "Item Group",
		...
		self.item_tax_template = vmraid.get_doc(
			{
			...
			doc = vmraid.get_doc(
				{
					...
					"currency": "USD",
					"schedule_date": vmraid.utils.nowdate(),
					"delivery_date": vmraid.utils.nowdate(),
